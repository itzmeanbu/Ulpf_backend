...
export function looksLikeGeneric(text: string): boolean {
  return typeof text === 'string' && text.trim().length > 0;
}

function findTimestamp(line: string): string {
...
function guessEventType(line: string): string {
...
export function parseGeneric(text: string): ParsedFields {
