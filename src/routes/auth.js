...
router.post('/register', async (req, res) => {
  ...
  try {
    ...
    if (err.code === '23505') {
      // Never reveal that an account exists. Answer exactly like a new sign-up
      // and leave the existing account untouched.
...
// (requireAuth already blocks disabled and pending accounts)
